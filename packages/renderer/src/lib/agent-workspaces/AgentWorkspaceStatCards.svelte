...
<div class="grid grid-cols-3 gap-3.5 mb-5">
  <div class="flex items-center gap-3.5 py-[18px] px-5 bg-[var(--pd-invert-content-card-bg)] border border-[var(--pd-content-card-border)] rounded-xl">
  ...
  <div class="flex items-center gap-3.5 py-[18px] px-5 bg-[var(--pd-invert-content-card-bg)] border border-[var(--pd-content-card-border)] rounded-xl">
    <div class="w-10 h-10 rounded-[10px] flex items-center justify-center shrink-0 bg-[color-mix(in_srgb,var(--pd-status-connected)_15%,transparent)] text-[var(--pd-status-connected)]">
